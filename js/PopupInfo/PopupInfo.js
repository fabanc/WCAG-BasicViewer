        ...
        makeSearchResultTemplate: function(address) {
            ...
            if(result !=='') {
                ...
                "<div class='esriViewPopup'>"+
                    ...
                    "<a class='locatorCopy' tabindex=0 onkeydown='if(event.keyCode===13 || event.keyCode===20) onclick='\"${LongLabel}\".copyToClipboard();' title='"+i18n.widgets.geoCoding.CopyToClipboard+"'>"+i18n.widgets.geoCoding.Copy+"</span>"+
                    "</div>";
            }
            return result;
        },
